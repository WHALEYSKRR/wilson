...
while ($info1=mysqli_fetch_array($data1))
{
    ...
    <td width="400">
    <label>NoRumah</label><br>
    <input type="text" name="noRumah" id="noRumah"
    placeholder="No.Rumah" size="60" required ><br>
    ...
    placeholder="11900" maxlength="5" size="7"
    onkeypress='return event.charCode >= 48 && event.charCode <=57' 
    required ><br>
...
<td width="400">
<select name="jenisBayaran" id="jenisBayaran">
...
<input hidden type="date" readonly name="tarikhJualan" 
